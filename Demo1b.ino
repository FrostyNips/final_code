...
int main()
{
 ...
 // ADC_init1();
  ...
  sensor[7] = var[10]; //sensor 7
   ...
   // Going Straight
     if (sensor[4]>THRESHOLD && sensor[5]>THRESHOLD && sensor[2]<THRESHOLD && sensor[7]<THRESHOLD) {
      
      motorSpeeds[0] = 105; // 120
      motorSpeeds[1] = 95; // 120
...
//    else if (sensor[5]>THRESHOLD&&sensor[8]>THRESHOLD){
//        
//        
//        stop = true; 
//        
